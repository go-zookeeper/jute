...
func (r *CreateContainerTxn) GetData() []byte {
	if r != nil && r.Data != nil {
		return r.Data
	}
	return nil
...
func (r *CreateContainerTxn) GetAcl() []*data.ACL {
	if r != nil && r.Acl != nil {
		return r.Acl
	}
	return nil
...
func (r *CreateContainerTxn) GetParentCVersion() int32 {
	if r != nil {
...
func (r *CreateContainerTxn) Read(dec jute.Decoder) (err error) {
	var size int
...
func (r *CreateContainerTxn) Write(enc jute.Encoder) error {
...
func (r *CreateContainerTxn) String() string {
	if r == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CreateContainerTxn(%+v)", *r)
}
